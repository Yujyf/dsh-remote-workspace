...
export class RemoteWorkspaceRuntime extends Service {
    ...
    async connectWorkspace(workspaceId) {
        ...
        if (parsed.type === 'wsl') {
            ...
            if (record !== undefined)
                workspace = this.toWorkspace(workspaceId, await this.ensureHostWorkspace(workspaceId, record));
        }
