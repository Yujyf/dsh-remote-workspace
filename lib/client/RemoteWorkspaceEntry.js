...
export function RemoteWorkspaceEntry(props) {
    ...
    const renderTargets = () => {
        ...
        return (_jsx("ul", { className: css.list, children: catalog.targets.map((target) => {
