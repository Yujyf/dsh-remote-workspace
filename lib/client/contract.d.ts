...
export type RemoteWorkspaceEntryProps = PropsRuntime<'sidebar.footer.action'> & PropsStore<RemoteWorkspaceStore> & Omit<RemoteWorkspaceInjected, 'hooks'> & PropsHooks<RemoteWorkspaceInjected['hooks']> & PropsLocale<'remote-workspace'>;
