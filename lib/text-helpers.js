 ...
 */
export function detectsCrlf(value) {
 ...
 */
export function restoreLineEndings(value, crlf) {
 ...
 */
export function assertNotAborted(signal, operation) {
 ...
 */
export function decodeTextBytes(bytes, displayPath, maxBytes) {
 ...
 */
export function literalEdit(content, request, displayPath) {
 ...
 */
export async function withKeyLock(locks, targetKey, op) {
    ...
    try {
        ...
        if (locks.get(targetKey) === tail)
            locks.delete(targetKey);
    }
}
