 ...
 */
export declare function WorkspaceTargetId(id: string): WorkspaceTargetId;
/**
 ...
 */
export declare function RemoteWorkspaceId(id: string): RemoteWorkspaceId;
/**
 ...
 */
export type WorkspaceTargetType = 'local' | 'wsl' | 'ssh' | 'docker' | 'podman' | 'kubernetes';
/** Live reachability of one target. */
export type WorkspaceTargetStatus = 'unknown' | 'ready' | 'starting' | 'stopped' | 'unavailable' | 'error';
/**
