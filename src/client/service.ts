...
export interface IRemoteWorkspaces {
   ...
   */
  resolveUri(targetId: WorkspaceTargetId, path: string): Promise<{ uri: string; title: string }>
  /**
...
export class RemoteWorkspacesController extends Service implements IRemoteWorkspaces {
  readonly list: RemoteWorkspaceSource
   ...
   */
  constructor(ctx: Context, private readonly model: ClientRemoteWorkspaceModel) {
